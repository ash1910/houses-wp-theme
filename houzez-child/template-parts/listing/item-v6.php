...
?>
<div class="col-lg-4 col-md-6 item-listing-wrap item-listing-grid hz-item-gallery-js item-listing-wrap-v6 card" data-hz-id="hz-<?php esc_attr_e($post->ID); ?>" <?php houzez_property_gallery($image_size); ?>>
  <div class="item-wrap item-wrap-v6 h-100">
    <div class="d-flex align-items-center h-100">
      <div class="item-header">
        ...
        <?php
        //  get_template_part('template-parts/listing/partials/item-tools'); 
        ?>

...
<section class="half-map-wrap map-on-left ss-half-map clearfix">

  <div class="row">
    <div class="col-lg-9">
      <div class="half-map-wrap-left" id="half-map-listing-area">
        <?php
        if ($enable_search != 0 && $search_style == 'v4') {
    ...
    <div class="col-lg-3">
      <div class="half-map-wrap-right" id="map-view-wrap">
        <div class="map-wrap">
